...
export default function Unauthenticated() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-orange-50 via-blue-50 to-orange-50 p-6">
      <div className="bg-white rounded-2xl shadow-2xl p-10 max-w-lg w-full text-center border-t-4 border-orange-500">
        ...
        <button onClick={handleMagicLink} className="px-8 py-4 bg-linear-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all font-semibold text-lg shadow-lg hover:shadow-xl">🔑 Sign In</button>
